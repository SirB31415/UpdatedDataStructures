...
//
//  Created by Brailow, Parker on 5/18/18.
...
void TestingStacksAndQueues :: stackVersusQueue()
{
    ...
    for (int index = 0; index < 10; index++)
    {
        stackFromQueue.push(queue.dequeque());
...
void TestingStacksAndQueues :: queueVersusList()
{
    ...
    cout << "Queue: " << wordQueue.getFromIndex(0) << " versus List: " << worddList.getFromIndex(0) << endl;
